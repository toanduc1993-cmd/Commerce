...
description: "[ĐÃ THAY THẾ BỞI IBSHI_Skill_SESSION_PROTOCOL_V2 — bản lưu trữ, không dùng]"
---

# [LƯU TRỮ] Nhiều phiên làm việc song song trên cùng một workspace

> Bản V1, giữ lại để tra lịch sử. Bản đang dùng: `.claude/skills/IBSHI_Skill_SESSION_PROTOCOL_V2/`.
